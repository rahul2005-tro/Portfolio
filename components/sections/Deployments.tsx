...
const DEPLOYMENTS = [
  ...
  {
    title: "TevrON Microgrid System",
    client: "Energy Management",
    description:
      "Intelligent microgrid management platform with real-time energy load monitoring, predictive load balancing algorithms, and an analytics-driven control dashboard.",
    tech: ["React", "Node.js", "Firebase", "AI/ML", "Dashboard"],
    live: "#",
